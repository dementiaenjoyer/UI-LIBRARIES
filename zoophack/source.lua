...
local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/dementiaenjoyer/UI-LIBRARIES/refs/heads/main/idk_what_this_is/extensions/tween.lua"))();
...
function library:new(cfg)
    ...
    -- // Drawings
    local window_outline = library:create("Square", {Visible = true, Transparency = 1, Color = Color3.fromRGB(45,45,45), Size = UDim2.new(0,size.X,0,size.Y), Position = UDim2.new(0.5, -(size.X / 2), 0.5, -(size.Y / 2)), Thickness = 1, Filled = true, ZIndex = 10}) do
    ...
    function window:page(cfg)
        ...
        function page:section(cfg)
            ...
            function section:preview(cfg)
                ...
                local esp_health_bar = library:create("Square", {Parent = esp_health_bar_outline; Size = UDim2.new(1,0,1,0), Color = Color3.fromRGB(0, 255, 42), Thickness = 1, Filled = true, ZIndex = 16, Position = UDim2.new(0,0,0,0)});
