local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/dementiaenjoyer/UI-LIBRARIES/main/cattoware/src.lua"))() --you can go into the github link and copy all of it and modify it for yourself.
